  ...
  */
  ...
  var createNode = function (doc, nodeName, key, statics, parent) {
    ...
    if (statics) {
      for (var i = 0; i < statics.length; i += 2) {
        ...
        /** @type {!string}*/statics[i], statics[i + 1]);
      }
    }
  ...
  var alignWithDOM = function (nodeName, key, statics) {
    ...
    if (existingNode) {
      ...
      matchingNode = createNode(context.doc, nodeName, key, statics, currentParent);
  ...
  var clearUnvisitedDOM = function () {
    ...
    if (data.attrs[exports.symbols.placeholder] && node !== context.root) {
      return;
    }
